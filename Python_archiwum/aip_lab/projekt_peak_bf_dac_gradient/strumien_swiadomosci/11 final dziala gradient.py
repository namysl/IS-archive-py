class Peak(object):
    ...
    def get_peak(self, algorithm):
        """Wybor algorytmu znajdujacego wierzcholek (dac, bf, gr),
        ...
        if algorithm == "dac":
            ...
            return Peak.bf(self)
        elif algorithm is "gr":
            return Peak.gr(self)
        else:
            print("Wybrano bledna nazwe algorytmu. \n \
                  Dostepne algorytmy: dac, bf, gr")
    ...
    def gr(self, start = (0, 0)): # GREEDY ASCENT
...
# przyklady dla algorytmow:
print('bf:')
n.bf() # brute force dla n
d.bf() # dla d
c.bf() # dla c
print('dac:')
print(n.dac(NN)) # divide dla n
print(d.dac(DD)) # dla n
print(c.dac(CC)) # dla d
print('gr:')
n.gr() # greedy dla n
d.gr() # dla d
c.gr() # dla c
# przyklady dla innych metod:
print('inne metody:')
d.print_list()
print(n.get_dim())
print(m.get_loc(15))
print(n.get_max_val())
print(d.get_val((1,1)))
print(c.next_element((1,1)))
print(m.get_list())
# get_peak:
print('get_peak:')
print(m.get_peak('dac'))
m.get_peak('bf')
m.get_peak('gr')
# setter:
print('setter')
print(i.set_list([[2, 2, 2], [1, 3, 1], [1, 2, 1]]))
