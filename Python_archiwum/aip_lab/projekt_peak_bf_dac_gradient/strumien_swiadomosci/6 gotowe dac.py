class Peak(object):
    ...
    def b(self, start = (0, 0)):
        ...
        if n == 0 and m == 0: # GÓRNY LEWY
            print('1')
        if n == self._n - 1 and m == 0: # DOLNY LEWY
            print('2')
        if n == 0 and m == self._m - 1: # GÓRNY PRAWY
            print('3')
        if n == self._n - 1 and m == self._m - 1: # DOLNY PRAWY
            print('4')
        if n == 0 and m < self._m: # górny rząd
            print('5')
        if n < self._n and m == 0: # lewa kolumna
            print('6')
        if n == self._n - 1 and m == self._m - 1: # dolny rząd 
            print('7')
        if n < self._n and m == self._m - 1: # prawa kolumna 
            print('8')
